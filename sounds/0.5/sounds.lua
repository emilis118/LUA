...
function main()
    ...
    if iniData.settings.firstTime then
        ...
        sampAddChatMessage(
            ltu('[Sounds] Dabar jei script nepavyks prisijungt prie serverio turėtų nebecrashint'),
            0x1cd031
        )
        sampAddChatMessage(
            ltu(
                '[Sounds] Aštuoni nauji garsai: {b88d0f}!pagalbininkai{1cd031}, {b88d0f}!parukyt{1cd031}, {b88d0f}!skyle, {b88d0f}!smaukai{1cd031}.'
            ),
            0x1cd031
        )
        sampAddChatMessage(
            ltu(
                '[Sounds] {b88d0f}!supratai{1cd031}, {b88d0f}!bekomentaru{1cd031}, {b88d0f}!bgalvi, {b88d0f}!pabazarink{1cd031}.'
            ),
            0x1cd031
        )
        sampAddChatMessage(ltu('-------------------------------------------------------------------'), 0x1cd031)
